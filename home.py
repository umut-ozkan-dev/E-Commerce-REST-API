...
<hr>
<h3>Welcome to High-End E-Commerce </h3>
<h3>Please select a button below to continue shopping ↓</h3>
<br>
...
<form method="get" action="./cart"><button type="submit">Shopping Cart</button></form>
